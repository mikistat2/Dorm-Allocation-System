    ...
    void handleSaveSettings(ActionEvent event) {
        try {
            ...
            for (int i = 1; i <= buildingsCount; i++) {
                ...
                javafx.scene.control.ChoiceDialog<String> dialog = new javafx.scene.control.ChoiceDialog<>("Male",
                        "Male", "Female");
                ...
                javafx.scene.control.Label headerLabel = (javafx.scene.control.Label) dialog.getDialogPane()
                        .lookup(".header .label");
                if (headerLabel != null) {
